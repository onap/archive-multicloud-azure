...
urlpatterns = [
    ...
    url(r'^api/multicloud-azure/v0/(?P<vimid>[0-9a-z-A-Z\-\_]+)/registry$',
        Registry.as_view()),
    url(r'^api/multicloud-azure/v1/(?P<cloud_owner>[0-9a-z-A-Z\-\_]+)/(?P<cloud_region>[0-9a-z-A-Z\-\_]+)/registry$',
        Registry.as_view()),
    url(r'^api/multicloud-azure/v0/(?P<vimid>[0-9a-z-A-Z\-\_]+)$',
        UnRegistry.as_view()),
    url(r'^api/multicloud-azure/v1/(?P<cloud_owner>[0-9a-z-A-Z\-\_]+)/(?P<cloud_region>[0-9a-z-A-Z\-\_]+)$',
        UnRegistry.as_view()),
